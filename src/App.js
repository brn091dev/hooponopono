  ...
  return (
    ...
    <section class="w-screen h-screen p-16 flex flex-col justify-between items-center bg-primary">
      <div class="divide-y divide-gray-400">
        <p class="text-lg lg:text-4xl xl:text-6xl font-black text-red-500 mb-5 text-center">HO'OPONOPONO</p>
        {
          number !== 0 &&
      ...
      <button
        class="mb-10 p-2 pl-5 pr-5 bg-transparent border-2 border-red-500 text-red-500 text-lg rounded-lg hover:bg-red-500 hover:text-gray-100 focus:border-4 focus:border-red-300"
        onClick={() => {
          setState(!state)
        }}
      >
